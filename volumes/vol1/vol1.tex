...
\begin{chapterintro}
Before a single transistor switches, before any bit is stored, 
there is a more fundamental question: what is data? Not how it 
is encoded — that comes later — but what it is at all, and why 
anything in the physical world should count as data in the first 
place.
\end{chapterintro}
