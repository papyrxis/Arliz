...
information. Given the sheer volume of data that
...
Because answers are so easily available, it is
...
paper, or the point of an assignment, at all.\\
...
confusion this causes is part of what motivates an observation worth
repeating: easy access to information makes the work of building
knowledge look optional. It is not. A search engine
can return information in a few nanoseconds; it
